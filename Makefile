...
# host files
#
HOST_SOURCES = ./App/Host.cpp  ./App/EventTimer.cpp ./App/Utilities.cpp ./Dedup/Dedup.cpp ./Server/encoder.cpp ./Server/server.cpp ./SHA_algorithm/SHA256.cpp ./SHA_algorithm/SHA_Test.cpp
