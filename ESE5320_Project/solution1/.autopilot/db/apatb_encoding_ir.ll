; ModuleID = '/mnt/castor/seas_home/a/adithyar/Deduplication-and-Compression/ESE5320_Project/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_encoding_ir(i8* %s1, i32 %length, i8* %output_code, i32 %output_code_len) local_unnamed_addr #0 {
entry:
  %s1_copy = alloca i8, align 512
  %output_code_copy = alloca i8, align 512
  call fastcc void @copy_in(i8* %s1, i8* nonnull align 512 %s1_copy, i8* %output_code, i8* nonnull align 512 %output_code_copy)
  call void @apatb_encoding_hw(i8* %s1_copy, i32 %length, i8* %output_code_copy, i32 %output_code_len)
  call fastcc void @copy_out(i8* %s1, i8* nonnull align 512 %s1_copy, i8* %output_code, i8* nonnull align 512 %output_code_copy)
  ret void
}
...
declare void @apatb_encoding_hw(i8*, i32, i8*, i32)

define void @encoding_hw_stub_wrapper(i8*, i32, i8*, i32) #5 {
entry:
  call void @copy_out(i8* null, i8* %0, i8* null, i8* %2)
  call void @encoding_hw_stub(i8* %0, i32 %1, i8* %2, i32 %3)
  call void @copy_in(i8* null, i8* %0, i8* null, i8* %2)
  ret void
}

declare void @encoding_hw_stub(i8*, i32, i8*, i32)
